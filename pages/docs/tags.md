...
Tags are a syntactic extension of standard [Markdown](https://www.markdownguide.org/). You can use native Markdoc tags, like [tables](#table), [conditionals](#if/else), and [partials](#partial), or create custom React components.
